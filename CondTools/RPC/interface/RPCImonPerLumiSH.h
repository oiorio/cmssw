#ifndef POPCON_RPC_DATA_PERLUMI_SRC_H
#define POPCON_RPC_DATA_PERLUMI_SRC_H
...
namespace popcon{
  class RpcDataIL : public popcon::PopConSourceHandler<RPCObImonPerLumi>{
  public:
    void getNewObjects();
    std::string id() const { return m_name;}
    ~RpcDataIL(); 
    RpcDataIL(const edm::ParameterSet& pset); 

    RPCObImonPerLumi* Idata;
