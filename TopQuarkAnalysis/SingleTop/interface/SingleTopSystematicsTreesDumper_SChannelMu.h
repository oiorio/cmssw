#ifndef __SINGLETOP_SYST_TREES_DUMPER_SCH_MU_H__
#define __SINGLETOP_SYST_TREES_DUMPER_SCH_MU_H__
 ...
 * \ version $Id: SingleTopSystematicsTreesDumper_SChannelMu.h,v 1.11.2.13.2.14.2.3 2013/04/18 10:29:50 oiorio Exp $
 */
...
class SingleTopSystematicsTreesDumper_SChannelMu : public edm::EDAnalyzer
{
public:
  explicit SingleTopSystematicsTreesDumper_SChannelMu(const edm::ParameterSet &);
  //  ~SingleTopSystematicsTreesDumper_SChannelMu();
...
float    MCTopsPtVec[2],
  ...
  bool doBScan_, doQCD_, doPDF_, takeBTagSFFromDB_,addPDFToNJets, doMCTruth_, doFullMCTruth_;
    ...
    //Variables to use as trees references
    double etaTree, etaTree2, cosTree, cosTree_bJet,cosTree_best, cosBLTree, cosBLbJet1Tree,cosBLbJet2Tree, topMassTree, topMassTree_fJet,topMassTree_best, totalWeightTree, weightTree, mtwMassTree, lowBTagTree, highBTagTree, maxPtTree, minPtTree, topMassLowBTagTree, topMassBestTopTree, topMassMeas, bWeightTree, PUWeightTree, turnOnWeightTree, limuWeightTree, turnOnReWeightTree, miscWeightTree, lepEff, lepEffB,lepSF,lepSFB,lepSFC,lepSFD, topMtwTree, HT ,H, Mlb1Tree, Mlb2Tree, Mb1b2Tree, pTb1b2Tree, 
    lepSFIDUp,
    lepSFIDDown,
    lepSFIsoUp,
    lepSFIsoDown,
    ...
    double bWeightTreeBTagUp,
      ...
      topPtReweight,
      topPtReweightMCTruth ,
      topPtReweightNorm,
      topPtReweightMCTruthNorm ;
  ...
  int nJ, nJNoPU, nJCentral, nJCentralNoPU, nJForward, nJForwardNoPU, nTCHPT, nCSVT, nCSVM;
    ...
    int runTree, eventTree, lumiTree, chargeTree, electronID, bJetFlavourTree, fJetFlavourTree, bestJetFlavourTree, highBJetFlavourTree, mediumBJetFlavourTree,  lowBJetFlavourTree, bJet1Flavour, bJet2Flavour, eventFlavourTree, puZero, firstJetFlavourTree, secondJetFlavourTree, thirdJetFlavourTree, isQCDTree;

    double lepPt, lepEta, lepPhi, lepE, lepRelIso, lepDeltaCorrectedRelIso, lepRhoCorrectedRelIso, fJetPhi, fJetPt, fJetEta, fJetE, bJetPt, bJetEta, bJetPhi, bJetE, highBJetPhi, highBJetPt, highBJetEta, highBJetE, lowBJetPhi, lowBJetPt, lowBJetEta, lowBJetE, mediumBJetPhi, mediumBJetPt, mediumBJetEta, mediumBJetE,  bJet1Pt,bJet1Eta,bJet1Phi,bJet1E,bJet2Pt,bJet2Eta,bJet2Phi,bJet2E, metPt, metPhi, topPt, topPhi, topEta, topE,topPt_fJet, topPhi_fJet, topEta_fJet, topE_fJet,topPt_best, topPhi_best, topEta_best, topE_best,WintPx,WintPy,WintPz,WintE,NuPx,NuPy,NuPz,NuE, totalEnergy, totalMomentum, highBJetBTag, mediumBJetBTag, lowBJetBTag, fJetBTag, bJetBTag, vtxZ, fJetPUID, fJetPUWP, bJetPUID, bJetPUWP,  highBJetPUID, highBJetPUWP, lowBJetPUID, lowBJetPUWP, mediumBJetPUID, mediumBJetPUWP,firstJetPt, firstJetEta, firstJetPhi, firstJetE, secondJetPt, secondJetEta, secondJetPhi, secondJetE, thirdJetPt, thirdJetEta, thirdJetPhi, thirdJetE,fJetBeta,fJetDZ,fJetRMS,bJetBeta,bJetDZ,bJetRMS,highBJetBeta, highBJetDZ, highBJetRMS, lowBJetBeta, lowBJetDZ, lowBJetRMS, mediumBJetBeta, mediumBJetDZ, mediumBJetRMS, leptonMVAID;
