#ifndef __SINGLETOP_SYST_TREES_DUMPER_SCH_ELE_H__
#define __SINGLETOP_SYST_TREES_DUMPER_SCH_ELE_H__
 ...
 * \ version $Id: SingleTopSystematicsTreesDumper_SChannelEle.h,v 1.11.2.13.2.14.2.1 2012/11/26 10:26:00 oiorio Exp $
 */
...
class SingleTopSystematicsTreesDumper_SChannelEle : public edm::EDAnalyzer
{
public:
  explicit SingleTopSystematicsTreesDumper_SChannelEle(const edm::ParameterSet &);
  //  ~SingleTopSystematicsTreesDumper_SChannelEle();
...
private:
  ...
  math::PtEtaPhiELorentzVector Wint4Momentum(float leptonPx, float leptonPy, float leptonPz,float leptonE, float jet1Px, float jet1Py, float jet1Pz,float jet1E, float jet2Px, float jet2Py, float jet2Pz,float jet2E, float metPx, float metPy);
  math::PtEtaPhiELorentzVector Wint4Momentum(math::PtEtaPhiELorentzVector lepton, math::PtEtaPhiELorentzVector jet1, math::PtEtaPhiELorentzVector jet2, float metPx, float metPy);
  
  math::PtEtaPhiELorentzVector Wint4Momentum(float leptonPx, float leptonPy, float leptonPz,float leptonE, float jet1Px, float jet1Py, float jet1Pz,float jet1E, float jet2Px, float jet2Py, float jet2Pz,float jet2E, float jet3Px, float jet3Py, float jet3Pz,float jet3E, float metPx, float metPy);
  math::PtEtaPhiELorentzVector Wint4Momentum(math::PtEtaPhiELorentzVector lepton, math::PtEtaPhiELorentzVector jet1, math::PtEtaPhiELorentzVector jet2, math::PtEtaPhiELorentzVector jet3, float metPx, float metPy);
  float cosTheta_bl_bjet(math::PtEtaPhiELorentzVector jet, math::PtEtaPhiELorentzVector Wint, int );
...
float    MCTopsPtVec[2],
  ...
  MCNeutrinosMotherIdVec[4]
    ...
    map<string, TTree *> trees2JNT;
    map<string, TTree *> trees3JNT;
  ...
  bool doBScan_, doQCD_, doPDF_, takeBTagSFFromDB_,addPDFToNJets, doMCTruth_, doFullMCTruth_, isSingleTopCompHEP_;
    ...
    //Variables to use as trees references
  double etaTree, etaTree2, cosTree,cosTree_bJet,cosTree_best, cosBLTree,cosBLTree_bJet,cosBLTree_best,cosBLbJet1Tree,cosBLbJet2Tree, topMassTree,topMassTree_fJet,topMassTree_best, totalWeightTree, weightTree, mtwMassTree, lowBTagTree, highBTagTree, maxPtTree, minPtTree, topMassLowBTagTree, topMassBestTopTree, topMassMeas, bWeightTree, PUWeightTree, turnOnWeightTree, limuWeightTree, turnOnReWeightTree, miscWeightTree, HT, H, Mlb1Tree, Mlb2Tree, Mb1b2Tree, pTb1b2Tree,lepEff, lepEffB,lepSF,lepSFB,lepSFC , lepSFD, topMtwTree, leptonMVAID,leptonNHits ;
  ...
  double topPtReweight, topPtReweightMCTruth,topPtReweightNorm, topPtReweightMCTruthNorm;
    ...
    int runTree, eventTree, lumiTree, chargeTree, electronID, bJetFlavourTree, fJetFlavourTree, bestJetFlavourTree, highBJetFlavourTree, mediumBJetFlavourTree, lowBJetFlavourTree, bJet1Flavour, bJet2Flavour, eventFlavourTree, puZero, firstJetFlavourTree, secondJetFlavourTree, thirdJetFlavourTree;


    double lepPt, lepEta, lepPhi, lepE, lepRelIso, lepDeltaCorrectedRelIso, lepRhoCorrectedRelIso, fJetPhi, fJetPt, fJetEta, fJetE, highBJetPhi, highBJetPt, highBJetEta, highBJetE, lowBJetPhi, lowBJetPt, lowBJetEta, lowBJetE, mediumBJetPhi, mediumBJetPt, mediumBJetEta, mediumBJetE, bJetPt, bJetEta, bJetPhi, bJetE, bJet1Pt,bJet1Eta,bJet1Phi,bJet1E,bJet2Pt,bJet2Eta,bJet2Phi,bJet2E, metPt, metPhi, topPt, topPhi, topEta, topE, topPt_fJet, topPhi_fJet, topEta_fJet, topE_fJet,topPt_best, topPhi_best, topEta_best, topE_best,WintPx,WintPy,WintPz,WintE,NuPx,NuPy,NuPz,NuE, totalEnergy, totalMomentum, highBJetBTag, mediumBJetBTag, lowBJetBTag,  fJetBTag, bJetBTag, vtxZ, fJetPUID, fJetPUWP, highBJetPUID, highBJetPUWP, lowBJetPUID, lowBJetPUWP, mediumBJetPUID, mediumBJetPUWP, bJetPUID, bJetPUWP, firstJetPt, firstJetEta, firstJetPhi, firstJetE, secondJetPt, secondJetEta, secondJetPhi, secondJetE, thirdJetPt, thirdJetEta, thirdJetPhi, thirdJetE,fJetBeta,fJetDZ,fJetRMS, bJetBeta,bJetDZ,bJetRMS, highBJetBeta, highBJetDZ, highBJetRMS, lowBJetBeta, lowBJetDZ, lowBJetRMS, mediumBJetBeta, mediumBJetDZ, mediumBJetRMS;
  bool bJetIsbest;   
