...
private:
  ...
  double EFFMap(string); double EFFMap(string, string);  double EFFErrMap(string); double EFFMapPt(string, double);
  ...
  int npv, nMCTruthLeptons;
    ...
    std::string leptonsFlavour_, mode_, CentralPDF_;
...
float    MCTopsPtVec[2],
  ...
  bool doBScan_, doQCD_, doPDF_, takeBTagSFFromDB_,addPDFToNJets, doMCTruth_, doFullMCTruth_;
    ...
    //Variables to use as trees references
  double etaTree, etaTree2, cosTree, cosBLTree, cosBTree, 
    cosB2Tree, cosB2BLTree, cosB2BTree, 
    topMassTree, topB2MassTree, 
    totalWeightTree, weightTree, mtwMassTree, lowBTagTree, highBTagTree, maxPtTree, minPtTree, topMassLowBTagTree, topMassBestTopTree, topMassMeas, bWeightTree, PUWeightTree, turnOnWeightTree, limuWeightTree, turnOnReWeightTree, miscWeightTree, lepEff, lepEffB,lepSF,lepSFB,lepSFC , lepSFD, topMtwTree, topB2MtwTree, HT ,
    lepSFIDUp,
    lepSFIDDown,
    lepSFIsoUp,
    lepSFIsoDown,
  ...
  int runTree, eventTree, lumiTree, chargeTree, electronID, 
bJetFlavourTree, 
secondBJetFlavourTree, 
fJetFlavourTree, eventFlavourTree, puZero, firstJetFlavourTree, secondJetFlavourTree, thirdJetFlavourTree, isQCDTree;

  double lepPt, lepEta, lepPhi, lepRelIso, lepDeltaCorrectedRelIso, lepRhoCorrectedRelIso, fJetPhi, fJetPt, fJetEta, fJetE, 
bJetPt, bJetEta, bJetPhi, bJetE, 
secondBJetPt, secondBJetEta, secondBJetPhi, secondBJetE, 
metPt, metPxVar, metPyVar,  metPhi, metPtNoCor, metPxVarNoCor, metPyVarNoCor,  metPhiVarNoCor, 
    topPt, topPhi, topEta, topE, 
    topB2Pt, topB2Phi, topB2Eta, topB2E, 
    totalEnergy, totalMomentum, fJetBTag, bJetBTag, 
    secondBJetBTag, 
vtxZ, fJetPUID, fJetPUWP, bJetPUID, bJetPUWP, firstJetPt, firstJetEta, firstJetPhi, firstJetE, secondJetPt, secondJetEta, secondJetPhi, secondJetE, thirdJetPt, thirdJetEta, thirdJetPhi, thirdJetE,fJetBeta,fJetDZ,fJetRMS,bJetBeta,bJetDZ,bJetRMS, leptonMVAID,leptonNHits;


    //Not used anymore:
    double loosePtCut, resolScale ;
    bool doPU_, doTurnOn_, doResol_, doMetPhiCorrections_ ;
  ...
  bool gotLeptons, gotJets, gotAllJets, gotMets, gotLooseLeptons, gotPU, gotQCDLeptons, gotPV,gotPDFs, gotVetoMuons, gotVetoElectrons;
