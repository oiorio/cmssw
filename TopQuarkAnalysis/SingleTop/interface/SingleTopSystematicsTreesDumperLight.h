#ifndef __SINGLETOP_SYST_TREES_DUMPER_LIGHT_H__
#define __SINGLETOP_SYST_TREES_DUMPER_LIGHT_H__
 ...
 * \ version $Id: SingleTopSystematicsTreesDumperLight.h,v 1.11.2.13.2.14.2.2 2013/03/22 00:22:47 oiorio Exp $
 */
...
class SingleTopSystematicsTreesDumperLight : public edm::EDAnalyzer
{
public:
  explicit SingleTopSystematicsTreesDumperLight(const edm::ParameterSet &);
  //  ~SingleTopSystematicsTreesDumperLight();
...
private:
  ...
  edm::Handle< double > UnclMETUpPx, UnclMETUpPy;
    edm::Handle< double > UnclMETDownPx, UnclMETDownPy;
