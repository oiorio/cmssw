/*
*\Author:  O.Iorio , F.R. Hosseinbadi 
*
*line 1812-1824 ,
*
...
#include "TopQuarkAnalysis/SingleTop/interface/SingleTopSystematicsTreesDumper_SChannelEle.h"
...
SingleTopSystematicsTreesDumper_SChannelEle::SingleTopSystematicsTreesDumper_SChannelEle(const edm::ParameterSet &iConfig)
{
    ...
    for (size_t i = 0; i < all_syst.size(); ++i)
    {
	    ...
	    if(addPDFToNJets){
            for (int p = 1; p <= 52; ++p)
	      {
            ...
            treesNJets[syst]->Branch("PDFWeight_Alternate_Set_1", &pdf_weights_alternate_set_1);
            treesNJets[syst]->Branch("PDFWeight_Alternate_Set_2", &pdf_weights_alternate_set_2);
	    }



            // 2J, nTags == 0 || 1 || 2
            string tree2JNTname = (channel + "_2J_" + syst);
            trees2JNT[syst] = new TTree(tree2JNTname.c_str(),tree2JNTname.c_str());

            // observables
            trees2JNT[syst]->Branch("leptonPt", &lepPt);
            trees2JNT[syst]->Branch("leptonEta", &lepEta);
            trees2JNT[syst]->Branch("leptonPhi", &lepPhi);
            trees2JNT[syst]->Branch("leptonE", &lepE);
            trees2JNT[syst]->Branch("leptonDeltaCorrectedRelIso", &lepDeltaCorrectedRelIso);
            trees2JNT[syst]->Branch("leptonRhoCorrectedRelIso", &lepRhoCorrectedRelIso);

            trees2JNT[syst]->Branch("leptonEff", &lepEff);
            trees2JNT[syst]->Branch("leptonEffB", &lepEffB);
	    trees2JNT[syst]->Branch("leptonSF", &lepSF);
            trees2JNT[syst]->Branch("leptonSFB", &lepSFB);
            trees2JNT[syst]->Branch("leptonSFC", &lepSFC);
            trees2JNT[syst]->Branch("leptonSFD", &lepSFD);
	    //
            trees2JNT[syst]->Branch("leptonSFIDUp", &lepSFIDUp);
            trees2JNT[syst]->Branch("leptonSFIDUpB", &lepSFIDUpB);
            trees2JNT[syst]->Branch("leptonSFIDUpC", &lepSFIDUpC);
            trees2JNT[syst]->Branch("leptonSFIDUpD", &lepSFIDUpD);
	    
            trees2JNT[syst]->Branch("leptonSFIDDown", &lepSFIDDown);
            trees2JNT[syst]->Branch("leptonSFIDDownB", &lepSFIDDownB);
            trees2JNT[syst]->Branch("leptonSFIDDownC", &lepSFIDDownC);
            trees2JNT[syst]->Branch("leptonSFIDDownD", &lepSFIDDownD);
	    //
	    trees2JNT[syst]->Branch("leptonSFIsoUp", &lepSFIsoUp);
            trees2JNT[syst]->Branch("leptonSFIsoUpB", &lepSFIsoUpB);
            trees2JNT[syst]->Branch("leptonSFIsoUpC", &lepSFIsoUpC);
            trees2JNT[syst]->Branch("leptonSFIsoUpD", &lepSFIsoUpD);

            trees2JNT[syst]->Branch("leptonSFIsoDown", &lepSFIsoDown);
            trees2JNT[syst]->Branch("leptonSFIsoDownB", &lepSFIsoDownB);
            trees2JNT[syst]->Branch("leptonSFIsoDownC", &lepSFIsoDownC);
            trees2JNT[syst]->Branch("leptonSFIsoDownD", &lepSFIsoDownD);
	    //
            trees2JNT[syst]->Branch("leptonSFTrigUp", &lepSFTrigUp);
            trees2JNT[syst]->Branch("leptonSFTrigUpB", &lepSFTrigUpB);
            trees2JNT[syst]->Branch("leptonSFTrigUpC", &lepSFTrigUpC);
            trees2JNT[syst]->Branch("leptonSFTrigUpD", &lepSFTrigUpD);

            trees2JNT[syst]->Branch("leptonSFTrigDown", &lepSFTrigDown);
            trees2JNT[syst]->Branch("leptonSFTrigDownB", &lepSFTrigDownB);
            trees2JNT[syst]->Branch("leptonSFTrigDownC", &lepSFTrigDownC);
            trees2JNT[syst]->Branch("leptonSFTrigDownD", &lepSFTrigDownD);
	    //

            trees2JNT[syst]->Branch("highBJetPt", &highBJetPt);
            trees2JNT[syst]->Branch("highBJetE", &highBJetE);
            trees2JNT[syst]->Branch("highBJetEta", &highBJetEta);
            trees2JNT[syst]->Branch("highBJetPhi", &highBJetPhi);
            trees2JNT[syst]->Branch("highBJetBtag", &highBJetBTag);
            trees2JNT[syst]->Branch("highBJetFlavour", &highBJetFlavourTree);
            trees2JNT[syst]->Branch("highBJetPUID", &highBJetPUID);
            trees2JNT[syst]->Branch("highBJetPUWP", &highBJetPUWP);

            trees2JNT[syst]->Branch("highBJetBeta", &highBJetBeta);
            trees2JNT[syst]->Branch("highBJetDZ", &highBJetDZ);
            trees2JNT[syst]->Branch("highBJetRMS", &highBJetRMS);



            trees2JNT[syst]->Branch("lowBJetPt", &lowBJetPt);
            trees2JNT[syst]->Branch("lowBJetE", &lowBJetE);
            trees2JNT[syst]->Branch("lowBJetEta", &lowBJetEta);
            trees2JNT[syst]->Branch("lowBJetPhi", &lowBJetPhi);
            trees2JNT[syst]->Branch("lowBJetBtag", &lowBJetBTag);
            trees2JNT[syst]->Branch("lowBJetFlavour", &lowBJetFlavourTree);
            trees2JNT[syst]->Branch("lowBJetPUID", &lowBJetPUID);
            trees2JNT[syst]->Branch("lowBJetPUWP", &lowBJetPUWP);

            trees2JNT[syst]->Branch("lowBJetBeta", &lowBJetBeta);
            trees2JNT[syst]->Branch("lowBJetDZ", &lowBJetDZ);
            trees2JNT[syst]->Branch("lowBJetRMS", &lowBJetRMS);


            trees2JNT[syst]->Branch("firstJetPt", &firstJetPt);
            trees2JNT[syst]->Branch("firstJetEta", &firstJetEta);
            trees2JNT[syst]->Branch("firstJetPhi", &firstJetPhi);
            trees2JNT[syst]->Branch("firstJetE", &firstJetE);
            trees2JNT[syst]->Branch("secondJetPt", &secondJetPt);
            trees2JNT[syst]->Branch("secondJetEta", &secondJetEta);
            trees2JNT[syst]->Branch("secondJetPhi", &secondJetPhi);
            trees2JNT[syst]->Branch("secondJetE", &secondJetE);



            // 3J, nTags == 0 || 1 || 2 || 3
            string tree3JNTname = (channel + "_3J_" + syst);
            trees3JNT[syst] = new TTree(tree3JNTname.c_str(),tree3JNTname.c_str());

            // observables
            trees3JNT[syst]->Branch("leptonPt", &lepPt);
            trees3JNT[syst]->Branch("leptonEta", &lepEta);
            trees3JNT[syst]->Branch("leptonPhi", &lepPhi);
            trees3JNT[syst]->Branch("leptonE", &lepE);
            trees3JNT[syst]->Branch("leptonDeltaCorrectedRelIso", &lepDeltaCorrectedRelIso);
            trees3JNT[syst]->Branch("leptonRhoCorrectedRelIso", &lepRhoCorrectedRelIso);

            trees3JNT[syst]->Branch("leptonEff", &lepEff);
            trees3JNT[syst]->Branch("leptonEffB", &lepEffB);
	    trees3JNT[syst]->Branch("leptonEff", &lepEff);
            trees3JNT[syst]->Branch("leptonEffB", &lepEffB);
	    trees3JNT[syst]->Branch("leptonSF", &lepSF);
            trees3JNT[syst]->Branch("leptonSFB", &lepSFB);
            trees3JNT[syst]->Branch("leptonSFC", &lepSFC);
	    //            trees3J[bj][syst]->Branch("leptonSFD", &lepSFD);



            trees3JNT[syst]->Branch("highBJetPt", &highBJetPt);
            trees3JNT[syst]->Branch("highBJetE", &highBJetE);
            trees3JNT[syst]->Branch("highBJetEta", &highBJetEta);
            trees3JNT[syst]->Branch("highBJetPhi", &highBJetPhi);
            trees3JNT[syst]->Branch("highBJetBtag", &highBJetBTag);
            trees3JNT[syst]->Branch("highBJetFlavour", &highBJetFlavourTree);
            trees3JNT[syst]->Branch("highBJetPUID", &highBJetPUID);
            trees3JNT[syst]->Branch("highBJetPUWP", &highBJetPUWP);

            trees3JNT[syst]->Branch("highBJetBeta", &highBJetBeta);
            trees3JNT[syst]->Branch("highBJetDZ", &highBJetDZ);
            trees3JNT[syst]->Branch("highBJetRMS", &highBJetRMS);

            trees3JNT[syst]->Branch("mediumBJetPt", &mediumBJetPt);
            trees3JNT[syst]->Branch("mediumBJetE", &mediumBJetE);
            trees3JNT[syst]->Branch("mediumBJetEta", &mediumBJetEta);
            trees3JNT[syst]->Branch("mediumBJetPhi", &mediumBJetPhi);
            trees3JNT[syst]->Branch("mediumBJetBtag", &mediumBJetBTag);
            trees3JNT[syst]->Branch("mediumBJetFlavour", &mediumBJetFlavourTree);
            trees3JNT[syst]->Branch("mediumBJetPUID", &mediumBJetPUID);
            trees3JNT[syst]->Branch("mediumBJetPUWP", &mediumBJetPUWP);

            trees3JNT[syst]->Branch("mediumBJetBeta", &mediumBJetBeta);
            trees3JNT[syst]->Branch("mediumBJetDZ", &mediumBJetDZ);
            trees3JNT[syst]->Branch("mediumBJetRMS", &mediumBJetRMS);

            trees3JNT[syst]->Branch("lowBJetPt", &lowBJetPt);
            trees3JNT[syst]->Branch("lowBJetE", &lowBJetE);
            trees3JNT[syst]->Branch("lowBJetEta", &lowBJetEta);
            trees3JNT[syst]->Branch("lowBJetPhi", &lowBJetPhi);
            trees3JNT[syst]->Branch("lowBJetBtag", &lowBJetBTag);
            trees3JNT[syst]->Branch("lowBJetFlavour", &lowBJetFlavourTree);
            trees3JNT[syst]->Branch("lowBJetPUID", &lowBJetPUID);
            trees3JNT[syst]->Branch("lowBJetPUWP", &lowBJetPUWP);

            trees3JNT[syst]->Branch("lowBJetBeta", &lowBJetBeta);
            trees3JNT[syst]->Branch("lowBJetDZ", &lowBJetDZ);
            trees3JNT[syst]->Branch("lowBJetRMS", &lowBJetRMS);

	    
            trees3JNT[syst]->Branch("firstJetPt", &firstJetPt);
            trees3JNT[syst]->Branch("firstJetEta", &firstJetEta);
            trees3JNT[syst]->Branch("firstJetPhi", &firstJetPhi);
            trees3JNT[syst]->Branch("firstJetE", &firstJetE);
            trees3JNT[syst]->Branch("secondJetPt", &secondJetPt);
            trees3JNT[syst]->Branch("secondJetEta", &secondJetEta);
            trees3JNT[syst]->Branch("secondJetPhi", &secondJetPhi);
            trees3JNT[syst]->Branch("secondJetE", &secondJetE);
            trees3JNT[syst]->Branch("thirdJetPt", &thirdJetPt);
            trees3JNT[syst]->Branch("thirdJetEta", &thirdJetEta);
            trees3JNT[syst]->Branch("thirdJetPhi", &thirdJetPhi);
            trees3JNT[syst]->Branch("thirdJetE", &thirdJetE);
	    ...
	    trees2J[bj][syst]->Branch("costhetalj_bJet", &cosTree_bJet);
            trees2J[bj][syst]->Branch("costhetalj_best", &cosTree_best);
            trees2J[bj][syst]->Branch("costhetalbl", &cosBLTree);
            trees2J[bj][syst]->Branch("costhetalbl_bJet", &cosBLTree_bJet);
            trees2J[bj][syst]->Branch("costhetalbl_best", &cosBLTree_best);
            trees2J[bj][syst]->Branch("mtwMass", &mtwMassTree);

	    trees2J[bj][syst]->Branch("costhetabJet1bl",&cosBLbJet1Tree);
	    trees2J[bj][syst]->Branch("costhetabJet2bl",&cosBLbJet2Tree);
	    ...
	    trees2J[bj][syst]->Branch("H", &H);
            trees2J[bj][syst]->Branch("topMass_fJet", &topMassTree_fJet);
            trees2J[bj][syst]->Branch("topMass_best", &topMassTree_best);
	    ...
	    trees2J[bj][syst]->Branch("topPt_fJet", &topPt_fJet);
            trees2J[bj][syst]->Branch("topPhi_fJet", &topPhi_fJet);
            trees2J[bj][syst]->Branch("topEta_fJet", &topEta_fJet);
            trees2J[bj][syst]->Branch("topE_fJet", &topE_fJet);
	    trees2J[bj][syst]->Branch("topPt_best", &topPt_best);
            trees2J[bj][syst]->Branch("topPhi_best", &topPhi_best);
	    trees2J[bj][syst]->Branch("topEta_best", &topEta_best);
            trees2J[bj][syst]->Branch("topE_best", &topE_best);

	    trees2J[bj][syst]->Branch("WintPx",&WintPx);
	    trees2J[bj][syst]->Branch("WintPy",&WintPy);
	    trees2J[bj][syst]->Branch("WintPz",&WintPz);
	    trees2J[bj][syst]->Branch("WintE",&WintE);

	    trees2J[bj][syst]->Branch("NuPx",&NuPx);
	    trees2J[bj][syst]->Branch("NuPy",&NuPy);
	    trees2J[bj][syst]->Branch("NuPz",&NuPz);
	    trees2J[bj][syst]->Branch("NuE",&NuE);
	      ...
	      for (int p = 1; p <= 4; ++p)
		{
		  ...
		  trees2J[bj][syst]->Branch("MCNeutrino"+num+"MotherId", &MCNeutrinosMotherIdVec[p-1]);
	        ...
	        trees3J[bj][syst]->Branch("costhetalj_bJet", &cosTree_bJet);
	  	    trees3J[bj][syst]->Branch("costhetalj_best", &cosTree_best);
            trees3J[bj][syst]->Branch("costhetalbl", &cosBLTree);
            trees3J[bj][syst]->Branch("costhetalbl_bJet", &cosBLTree_bJet);
            trees3J[bj][syst]->Branch("costhetalbl_best", &cosBLTree_best);
            trees3J[bj][syst]->Branch("topMass", &topMassTree);
	  	    trees3J[bj][syst]->Branch("topMass_fJet", &topMassTree_fJet);
	    	trees3J[bj][syst]->Branch("topMass_best", &topMassTree_best);
	    ...
	    //            trees3J[bj][syst]->Branch("leptonSFD", &lepSFD);
            ...
            trees3J[bj][syst]->Branch("costhetabJet1bl",&cosBLbJet1Tree);
            trees3J[bj][syst]->Branch("costhetabJet2bl",&cosBLbJet2Tree);
            ...
            trees3J[bj][syst]->Branch("highBJetPt", &highBJetPt);
            trees3J[bj][syst]->Branch("highBJetE", &highBJetE);
            trees3J[bj][syst]->Branch("highBJetEta", &highBJetEta);
            trees3J[bj][syst]->Branch("highBJetPhi", &highBJetPhi);
            trees3J[bj][syst]->Branch("highBJetBtag", &highBJetBTag);
            trees3J[bj][syst]->Branch("highBJetFlavour", &highBJetFlavourTree);
            trees3J[bj][syst]->Branch("highBJetPUID", &highBJetPUID);
            trees3J[bj][syst]->Branch("highBJetPUWP", &highBJetPUWP);

            trees3J[bj][syst]->Branch("highBJetBeta", &highBJetBeta);
            trees3J[bj][syst]->Branch("highBJetDZ", &highBJetDZ);
            trees3J[bj][syst]->Branch("highBJetRMS", &highBJetRMS);

            trees3J[bj][syst]->Branch("mediumBJetPt", &mediumBJetPt);
            trees3J[bj][syst]->Branch("mediumBJetE", &mediumBJetE);
            trees3J[bj][syst]->Branch("mediumBJetEta", &mediumBJetEta);
            trees3J[bj][syst]->Branch("mediumBJetPhi", &mediumBJetPhi);
            trees3J[bj][syst]->Branch("mediumBJetBtag", &mediumBJetBTag);
            trees3J[bj][syst]->Branch("mediumBJetFlavour", &mediumBJetFlavourTree);
            trees3J[bj][syst]->Branch("mediumBJetPUID", &mediumBJetPUID);
            trees3J[bj][syst]->Branch("mediumBJetPUWP", &mediumBJetPUWP);

            trees3J[bj][syst]->Branch("mediumBJetBeta", &mediumBJetBeta);
            trees3J[bj][syst]->Branch("mediumBJetDZ", &mediumBJetDZ);
            trees3J[bj][syst]->Branch("mediumBJetRMS", &mediumBJetRMS);

            trees3J[bj][syst]->Branch("lowBJetPt", &lowBJetPt);
            trees3J[bj][syst]->Branch("lowBJetE", &lowBJetE);
            trees3J[bj][syst]->Branch("lowBJetEta", &lowBJetEta);
            trees3J[bj][syst]->Branch("lowBJetPhi", &lowBJetPhi);
            trees3J[bj][syst]->Branch("lowBJetBtag", &lowBJetBTag);
            trees3J[bj][syst]->Branch("lowBJetFlavour", &lowBJetFlavourTree);
            trees3J[bj][syst]->Branch("lowBJetPUID", &lowBJetPUID);
            trees3J[bj][syst]->Branch("lowBJetPUWP", &lowBJetPUWP);

            trees3J[bj][syst]->Branch("lowBJetBeta", &lowBJetBeta);
            trees3J[bj][syst]->Branch("lowBJetDZ", &lowBJetDZ);
            trees3J[bj][syst]->Branch("lowBJetRMS", &lowBJetRMS);
	    ...
	    trees3J[bj][syst]->Branch("topPt_fJet", &topPt_fJet);
	    trees3J[bj][syst]->Branch("topPhi_fJet", &topPhi_fJet);
	    trees3J[bj][syst]->Branch("topEta_fJet", &topEta_fJet);
	    trees3J[bj][syst]->Branch("topE_fJet", &topE_fJet);
	    trees3J[bj][syst]->Branch("topPt_best", &topPt_best);
	    trees3J[bj][syst]->Branch("topPhi_best", &topPhi_best);
	    trees3J[bj][syst]->Branch("topEta_best", &topEta_best);
	    trees3J[bj][syst]->Branch("topE_best", &topE_best);
	    

            trees3J[bj][syst]->Branch("WintPx",&WintPx);
            trees3J[bj][syst]->Branch("WintPy",&WintPy);
            trees3J[bj][syst]->Branch("WintPz",&WintPz);
            trees3J[bj][syst]->Branch("WintE",&WintE);

            trees3J[bj][syst]->Branch("NuPx",&NuPx);
            trees3J[bj][syst]->Branch("NuPy",&NuPy);
            trees3J[bj][syst]->Branch("NuPz",&NuPz);
            trees3J[bj][syst]->Branch("NuE",&NuE);
    ...
    isFirstEvent = true;
}// end class definition of 

void SingleTopSystematicsTreesDumper_SChannelEle::initBranchVars()
{
#define INT_NAN 9999
...
#define DOUBLE_NAN 9999.0
    ...
    etaTree = DOUBLE_NAN;
    cosTree = DOUBLE_NAN;
    cosTree_bJet = DOUBLE_NAN;
    cosTree_best = DOUBLE_NAN;
    cosBLTree = DOUBLE_NAN;
    cosBLTree_bJet = DOUBLE_NAN;
    ...
    highBJetFlavourTree = INT_NAN;
    mediumBJetFlavourTree = INT_NAN;
    lowBJetFlavourTree = INT_NAN;
    bJetFlavourTree = INT_NAN;
    bestJetFlavourTree = INT_NAN;
    eventFlavourTree = INT_NAN;
    nVertices = INT_NAN;
    npv = INT_NAN;
    firstJetFlavourTree = INT_NAN;
    ...
    highBJetPt = DOUBLE_NAN;
    highBJetE = DOUBLE_NAN;
    highBJetEta = DOUBLE_NAN;
    highBJetPhi = DOUBLE_NAN;
    highBJetBTag = DOUBLE_NAN;
    highBJetPUID = DOUBLE_NAN;
    highBJetPUWP = DOUBLE_NAN;

    mediumBJetPt = DOUBLE_NAN;
    mediumBJetE = DOUBLE_NAN;
    mediumBJetEta = DOUBLE_NAN;
    mediumBJetPhi = DOUBLE_NAN;
    mediumBJetBTag = DOUBLE_NAN;
    mediumBJetPUID = DOUBLE_NAN;
    mediumBJetPUWP = DOUBLE_NAN;
    
    lowBJetPt = DOUBLE_NAN;
    lowBJetE = DOUBLE_NAN;
    lowBJetEta = DOUBLE_NAN;
    lowBJetPhi = DOUBLE_NAN;
    lowBJetBTag = DOUBLE_NAN;
    lowBJetPUID = DOUBLE_NAN;
    lowBJetPUWP = DOUBLE_NAN;
    ...
    topEta = DOUBLE_NAN;
    topE = DOUBLE_NAN;
    topPt_fJet = DOUBLE_NAN;
    topPhi_fJet = DOUBLE_NAN;
    topEta_fJet = DOUBLE_NAN;
    topE_fJet = DOUBLE_NAN;
    topPt_best = DOUBLE_NAN;
    topPhi_best = DOUBLE_NAN;
    topEta_best = DOUBLE_NAN;
    topE_best = DOUBLE_NAN;
...
void SingleTopSystematicsTreesDumper_SChannelEle::analyze(const Event &iEvent, const EventSetup &iSetup)
{
  ...
  //
    ...
    //cout <<" test 1 "<<endl;
    iEvent.getByLabel(jetsEta_, jetsEta); //jetsEta_ :input tag /jetsEta: edm ::handle
    ...
    math::PtEtaPhiELorentzVector Wint;
    ...
    int mediumBTagTreePositionNoSyst = -1;
	...
	if( syst == "noSyst" && doMCTruth_ && doFullMCTruth_){
		...
		if(isSingleTopCompHEP_){
		  ...
		  if( (!(MCBQuarksEta->size() < p)) && (!(MCTopWsEta->size() < p))){
		    ...
		    topPtReweight*=topPtReweighting("semilepton",mctop.pt());
		...
		if(MCTopsPtVec[p-1]>-1){topPtReweightMCTruth*=topPtReweighting(chanrew,MCTopsPtVec[p-1]);}
	      ...
	      //	      topPtReweightNorm = topPtReweight;
	      //topPtReweightMCTruthNorm = topPtReweightMCTruth;
	...
	cout << " syst " << syst_name << " met pt " << sqrt(metPx*metPx+metPy*metPy) << endl ;
		...
		H+= (math::PtEtaPhiELorentzVector(ptCorr, jetsEta->at(i), jetsPhi->at(i), energyCorr)).E();

		/*

		if (i==1)
		  Wint = Wint4Momentum(leptons[0], math::PtEtaPhiELorentzVector(jetsPt->at(0),jetsEta->at(0),jetsPhi->at(0),jetsEnergy->at(0)),
				       math::PtEtaPhiELorentzVector(jetsPt->at(1),jetsEta->at(1),jetsPhi->at(1),jetsEnergy->at(1)),metPx,metPy);
		if (i>1){
		  Wint += (math::PtEtaPhiELorentzVector(jetsPt->at(i),jetsEta->at(i),jetsPhi->at(i),jetsEnergy->at(i)));
		...
		*/
                ...
                if (passesAlgo)
		{
		    ...
		    flavours_bjets[nBJets-1] = flavours[nJets-1];
		   
		    // TO CHECK
		    /*
		    if (nBJets == 1){
		      bJet1PUID = jetsPileUpID->at(i);
		      bJet1PUWP = jetsPileUpWP->at(i);
		      bJet1Beta = jetsBeta->at(i);
		      bJet1DZ   = jetsDZ->at(i);
		      bJet1RMS  = jetsRMS->at(i);
		    }
		    if (nBJets == 2){
                      bJet2PUID = jetsPileUpID->at(i);
                      bJet2PUWP = jetsPileUpWP->at(i);
                      bJet2Beta = jetsBeta->at(i);
                      bJet2DZ   = jetsDZ->at(i);
                      bJet2RMS  = jetsRMS->at(i);
		    }
		    */
		}
		...
		//		cout << "i: "<< i <<"  jets size: "<< nJets << "   btag: " << valueChosenAlgo <<endl;
                if (valueChosenAlgo > highBTagTree)
		  {

		    if (nJets==3){
		      mediumBJetBTag = highBJetBTag;
		    ...
		    bJetBTag = valueChosenAlgo;

                    highBJetFlavourTree = jetsFlavour->at(i);
                    highBJetPUID = jetsPileUpID->at(i);
                    highBJetPUWP = jetsPileUpWP->at(i);

                    highBJetBeta = jetsBeta->at(i);
		    highBJetDZ = jetsDZ->at(i);
		    highBJetRMS = jetsRMS->at(i);
		    highBJetBTag = valueChosenAlgo;
		  ...
		  if (nJets==3){
		    ...
		    lowBJetFlavourTree = jetsFlavour->at(i);
                    lowBJetPUID = jetsPileUpID->at(i);
                    lowBJetPUWP = jetsPileUpWP->at(i);

                    lowBJetBeta = jetsBeta->at(i);
                    lowBJetDZ = jetsDZ->at(i);
                    lowBJetRMS = jetsRMS->at(i);
		    lowBJetBTag = valueChosenAlgo;
                ...
                if ( ( (valueChosenAlgo < highBTagTree) && (valueChosenAlgo > lowBTagTree) ) )   // || ( (valueChosenAlgo == highBTagTree) || (valueChosenAlgo == lowBTagTree) ))
		  {
		    ...
		    //		    mediumBJetFlavourTree = jetsFlavour->at(i);
		    //                    mediumBJetPUID = jetsPileUpID->at(i);
		    //                    mediumBJetPUWP = jetsPileUpWP->at(i);
		    
		    //                    mediumBJetBeta = jetsBeta->at(i);
		    //                    mediumBJetDZ = jetsDZ->at(i);
		    //                    mediumBJetRMS = jetsRMS->at(i);
                    mediumBJetBTag = valueChosenAlgo;
		    
				    
		  }
		
		else if ((nJets == 3) && (mediumBJetBTag == -100)){
		  mediumBTagTreePosition = nJets - 1;
		  
		  
		  // cout << "i: "<< i <<"  jets size: "<< nJets << "   btagH: " << highBJetBTag << "   btagM: " << mediumBJetBTag << "   btagL: " << lowBJetBTag <<  endl;
		}

		/*		
		cout << "i: "<< i  << "  nJets: " << nJets << "  value: " << valueChosenAlgo  
		     << "  high: "   << highBJetBTag   << "  pos: " << highBTagTreePosition 
		     << "  medium: " << mediumBJetBTag << "  pos: " << mediumBTagTreePosition
		     << "  low: "    << lowBJetBTag    << "  pos: " << lowBTagTreePosition  <<endl;   
		*/
	  ...
	  mediumBTagTreePositionNoSyst = mediumBTagTreePosition;
	  lowBTagTreePositionNoSyst = lowBTagTreePosition;
		...
		//		cout <<" jet no syst "<< a <<" pt "  <<jets[a].pt()<<endl;
            ...
            mediumBTagTreePosition = mediumBTagTreePositionNoSyst;
	...
	cout << "BEFORE nJets: " << nJets << "  nJetsTight: " << nJetsTight << endl;
	*/

	if (secondPt < ptCutTight)
	  nJets = nJetsTight;

	//	cout << "AFTER nJets: " << nJets << "  nJetsTight: " << nJetsTight << endl;
        ...
        if (doJetTrees_ && !isQCD)
	  {
	    ...
	    math::PtEtaPhiELorentzVector top_fJet = top4Momentum(leptonPFour, jets[lowBTagTreePosition], metPx, metPy);
            float fCosThetaLJ =  cosThetaLJ(leptonPFour, jets[lowBTagTreePosition], top);
	    float fCosThetaLJ_bJet =  cosThetaLJ(leptonPFour, jets[highBTagTreePosition], top_fJet);
            cosBLTree =  cosTheta_eta_bl(leptonPFour, jets[lowBTagTreePosition], top);
			cosBLTree_bJet =  cosTheta_eta_bl(leptonPFour, jets[highBTagTreePosition], top_fJet);
	    double lepton_Pt = sqrt( leptonPFour.px()*leptonPFour.px() + leptonPFour.py()*leptonPFour.py() );
	    math::XYZTLorentzVector neutrino = NuMomentum(leptonPFour.px(),leptonPFour.py(),leptonPFour.pz(),lepton_Pt,leptonPFour.E(),metPx,metPy);



	    if (B == 2 || B == 5){   // B == 5 for 2T_QCD sample 
	      Wint = Wint4Momentum(leptonPFour, bjets[0], bjets[1], metPx, metPy);
	      if (nJets == 3)
		Wint = Wint4Momentum(leptonPFour, jets[highBTagTreePosition], jets[mediumBTagTreePosition], jets[lowBTagTreePosition] ,metPx, metPy);

	      
	      double bjet1cos, bjet2cos;
	      double Mlb1, Mlb2, Mb1b2, pTb1b2;
	      
	      bjet1cos =  cosTheta_bl_bjet(bjets[0], Wint, chargeTree);
	      bjet2cos =  cosTheta_bl_bjet(bjets[1], Wint, chargeTree);
	      ...
	      Mb1b2Tree  = Mb1b2;
	      pTb1b2Tree = pTb1b2;
	      cosBLbJet1Tree = bjet1cos;
	      cosBLbJet2Tree = bjet2cos;
	      Mlb1Tree = Mlb1;
	      Mlb2Tree = Mlb2;
	      ...
	      bJet2Flavour = flavours_bjets[1];
            ...
            cosTree = fCosThetaLJ;
            cosTree_bJet = fCosThetaLJ_bJet;
            topMassTree = top.mass();
	        topMassTree_fJet = top_fJet.mass();

            topMtwTree = topMtw(leptonPFour, jets[highBTagTreePosition], metPx, metPy);

	    math::PtEtaPhiELorentzVector top_best =(abs(topMassTree-172.5)<abs(topMassTree_fJet-172.5))? top: top_fJet;
	    if(top_best==top) {cosBLTree_best=cosBLTree; cosTree_best=cosTree;  bestJetFlavourTree = bJetFlavourTree; topMassTree_best =topMassTree;bJetIsbest=true;}
	    else {cosBLTree_best=cosBLTree_bJet; cosTree_best=cosTree_bJet; bestJetFlavourTree = fJetFlavourTree; topMassTree_best=topMassTree_fJet;bJetIsbest=false;}

	    //std::cout<<"abs(topMassTree-172.5)"<<abs(topMassTree-172.5)<<"\tabs(topMassTree_fJet-172.5)"<<abs(topMassTree_fJet-172.5)<<endl;
	   // std::cout<<"topMassTree_best"<<topMassTree_best<<"\ttopMassTree_fJet"<<topMassTree_fJet<<endl;
	    ...
	    if (leptonsFlavour_ == "electron" )lepEff = 1;
            ...
            lowBJetPt = jets[lowBTagTreePosition].pt();
            lowBJetE = jets[lowBTagTreePosition].energy();
            lowBJetEta = jets[lowBTagTreePosition].eta();
            lowBJetPhi = jets[lowBTagTreePosition].phi();

            mediumBJetPt = jets[mediumBTagTreePosition].pt();
            mediumBJetE = jets[mediumBTagTreePosition].energy();
            mediumBJetEta = jets[mediumBTagTreePosition].eta();
            mediumBJetPhi = jets[mediumBTagTreePosition].phi();

            highBJetPt = jets[highBTagTreePosition].pt();
            highBJetE = jets[highBTagTreePosition].energy();
            highBJetEta = jets[highBTagTreePosition].eta();
            highBJetPhi = jets[highBTagTreePosition].phi();
	    ...
	    topEta_fJet = top_fJet.eta();
	    topPhi_fJet = top_fJet.phi();
	    topPt_fJet = top_fJet.pt();   
	    topEta_best = top_best.eta();
	    topPhi_best = top_best.phi();
	    topPt_best = top_best.pt();
	    ...
	    if( ( ( (B==1 || B==2) && nJets ==2 ) || (B==2 && nJets==3) )&& syst == "noSyst" && doMCTruth_){
		...
		if(!(MCLeptonsEta->size() < p) ){
		  MCLeptonsEtaVec[p-1]=MCLeptonsEta->at(p-1);
		  //  cout << " lepton eta "<< MCLeptonsEtaVec[p-1]<<endl;
		  MCLeptonsPhiVec[p-1]=MCLeptonsPhi->at(p-1);
		  MCLeptonsPtVec[p-1]=MCLeptonsPt->at(p-1);
		  MCLeptonsEnergyVec[p-1]=MCLeptonsEnergy->at(p-1);
		  MCLeptonsPdgIdVec[p-1]=MCLeptonsPdgId->at(p-1);
		...
		if(!(MCBQuarksEta->size() < p) ){
		  MCBQuarksEtaVec[p-1]=MCBQuarksEta->at(p-1);
		  //  cout << " lepton eta "<< MCBQuarksEtaVec[p-1]<<endl;
		  MCBQuarksPhiVec[p-1]=MCBQuarksPhi->at(p-1);
		  MCBQuarksPtVec[p-1]=MCBQuarksPt->at(p-1);
		  MCBQuarksEnergyVec[p-1]=MCBQuarksEnergy->at(p-1);
		  MCBQuarksPdgIdVec[p-1]=MCBQuarksPdgId->at(p-1);
		...
		if(!(MCNeutrinosEta->size() < p) ){
		  MCNeutrinosEtaVec[p-1]=MCNeutrinosEta->at(p-1);
		  //  cout << " lepton eta "<< MCNeutrinosEtaVec[p-1]<<endl;
		  MCNeutrinosPhiVec[p-1]=MCNeutrinosPhi->at(p-1);
		  MCNeutrinosPtVec[p-1]=MCNeutrinosPt->at(p-1);
		  MCNeutrinosEnergyVec[p-1]=MCNeutrinosEnergy->at(p-1);
		  MCNeutrinosPdgIdVec[p-1]=MCNeutrinosPdgId->at(p-1);
		...
		if (MCTopWsEta->size() < p)continue;
		//		cout << " loop 2 "<<endl;
		//if (abs(MCTopWsDauOneId->at(p-1)) > 6){
		if(MCTopNeutrinosEta->size()!=MCTopLeptonsEta->size())continue;
		if(MCTopQuarksEta->size()!=MCTopQuarkBarsEta->size())continue;
		...
		if(isLeptonic){
		  MCTopLeptonsEtaVec[p-1]=MCTopLeptonsEta->at(position-1);
		  //  cout << " lepton eta "<< MCTopLeptonsEtaVec[p-1]<<endl;
		  MCTopLeptonsPhiVec[p-1]=MCTopLeptonsPhi->at(position-1);
		  MCTopLeptonsPtVec[p-1]=MCTopLeptonsPt->at(position-1);
		  MCTopLeptonsEnergyVec[p-1]=MCTopLeptonsEnergy->at(position-1);
		  MCTopLeptonsPdgIdVec[p-1]=MCTopLeptonsPdgId->at(position-1);
...
float SingleTopSystematicsTreesDumper_SChannelEle::cosThetaLJ(math::PtEtaPhiELorentzVector lepton, math::PtEtaPhiELorentzVector jet, math::PtEtaPhiELorentzVector top)
{
...
//CosTheta-bjet-beam-line in Wint rest frame
float SingleTopSystematicsTreesDumper_SChannelEle::cosTheta_bl_bjet(math::PtEtaPhiELorentzVector jet, math::PtEtaPhiELorentzVector Wint, int chargeTree)
{

  double pzWint = Wint.pz();

  double z;

  if (pzWint*chargeTree > 0)
    //if (pzWint > 0)
    {
      z = 1.0;
    }
  ...
  math::PtEtaPhiELorentzVector boostedJet = ROOT::Math::VectorUtil::boost(jet, Wint.BoostToCM());
  math::XYZTLorentzVector boostedBeamLine = ROOT::Math::VectorUtil::boost(beamLine, Wint.BoostToCM());

  //  cout << "Angle between beam axis and b-jet:  " << ROOT::Math::VectorUtil::Angle(boostedBeamLine.Vect(),boostedJet.Vect()) << endl;
  //  cout << "Cos of the angle between beam axis and b-jet:  " << ROOT::Math::VectorUtil::CosTheta(boostedBeamLine.Vect(), boostedJet.Vect()) << endl;

  //  cout << "Cos1: " << ROOT::Math::VectorUtil::CosTheta(boostedBeamLine.Vect(), boostedJet.Vect()) << endl;
  //  cout << "Cos2: " << ROOT::Math::VectorUtil::CosTheta(boostedJet.Vect(), boostedBeamLine.Vect()) << endl;

  return ROOT::Math::VectorUtil::CosTheta(boostedBeamLine.Vect(), boostedJet.Vect());

}

//Intermediate W boson 4-momentum given lepton, met and b-jets
math::PtEtaPhiELorentzVector SingleTopSystematicsTreesDumper_SChannelEle::Wint4Momentum(math::PtEtaPhiELorentzVector lepton, math::PtEtaPhiELorentzVector jet1, math::PtEtaPhiELorentzVector jet2, float metPx, float metPy){
  return Wint4Momentum(lepton.px(),lepton.py(),lepton.pz(),lepton.energy(),jet1.px(),jet1.py(),jet1.pz(),jet1.energy(),jet2.px(),jet2.py(),jet2.pz(),jet2.energy(),metPx,metPy);
}

math::PtEtaPhiELorentzVector SingleTopSystematicsTreesDumper_SChannelEle::Wint4Momentum(math::PtEtaPhiELorentzVector lepton, math::PtEtaPhiELorentzVector jet1, math::PtEtaPhiELorentzVector jet2, math::PtEtaPhiELorentzVector jet3, float metPx, float metPy){
  return Wint4Momentum(lepton.px(),lepton.py(),lepton.pz(),lepton.energy(),jet1.px(),jet1.py(),jet1.pz(),jet1.energy(),jet2.px(),jet2.py(),jet2.pz(),jet2.energy(),jet3.px(),jet3.py(),jet3.pz(),jet3.energy(),metPx,metPy);
}

//Intermediate W boson 4-momentum original function given the necessary parameters
math::PtEtaPhiELorentzVector SingleTopSystematicsTreesDumper_SChannelEle::Wint4Momentum(float leptonPx, float leptonPy, float leptonPz, float leptonE, float jet1Px, float jet1Py, float jet1Pz, float jet1E, float jet2Px, float jet2Py, float jet2Pz, float jet2E, float metPx, float metPy){
  ...
  math::XYZTLorentzVector jet1(jet1Px,jet1Py,jet1Pz,jet1E);
  math::XYZTLorentzVector jet2(jet2Px,jet2Py,jet2Pz,jet2E);

  math::XYZTLorentzVector Wint = lep + jet1 + jet2 + neutrino;
  return math::PtEtaPhiELorentzVector(Wint.pt(),Wint.eta(),Wint.phi(),Wint.E());
}


 math::PtEtaPhiELorentzVector SingleTopSystematicsTreesDumper_SChannelEle::Wint4Momentum(float leptonPx, float leptonPy, float leptonPz, float leptonE, float jet1Px, float jet1Py, float jet1Pz, float jet1E, float jet2Px, float jet2Py, float jet2Pz, float jet2E, float jet3Px, float jet3Py, float jet3Pz, float jet3E, float metPx, float metPy){
   ...
   math::XYZTLorentzVector jet1(jet1Px,jet1Py,jet1Pz,jet1E);
   math::XYZTLorentzVector jet2(jet2Px,jet2Py,jet2Pz,jet2E);
   math::XYZTLorentzVector jet3(jet3Px,jet3Py,jet3Pz,jet3E);

   math::XYZTLorentzVector Wint = lep + jet1 + jet2 + jet3 + neutrino;
   return math::PtEtaPhiELorentzVector(Wint.pt(),Wint.eta(),Wint.phi(),Wint.E());
 }
...
float SingleTopSystematicsTreesDumper_SChannelEle::cosTheta_eta_bl(math::PtEtaPhiELorentzVector lepton, math::PtEtaPhiELorentzVector jet, math::PtEtaPhiELorentzVector top)
{
...
double SingleTopSystematicsTreesDumper_SChannelEle::topMtw(math::PtEtaPhiELorentzVector lepton, math::PtEtaPhiELorentzVector jet, float metPx, float metPy)
{
...
math::PtEtaPhiELorentzVector SingleTopSystematicsTreesDumper_SChannelEle::top4Momentum(math::PtEtaPhiELorentzVector lepton, math::PtEtaPhiELorentzVector jet, float metPx, float metPy)
{
...
math::PtEtaPhiELorentzVector SingleTopSystematicsTreesDumper_SChannelEle::top4Momentum(float leptonPx, float leptonPy, float leptonPz, float leptonE, float jetPx, float jetPy, float jetPz, float jetE, float metPx, float metPy)
{
    float lepton_Pt = sqrt( (leptonPx * leptonPx) +  (leptonPy * leptonPy) );
...
math::XYZTLorentzVector SingleTopSystematicsTreesDumper_SChannelEle::NuMomentum(float leptonPx, float leptonPy, float leptonPz, float leptonPt, float leptonE, float metPx, float metPy )
{
...
double SingleTopSystematicsTreesDumper_SChannelEle::jetUncertainty(double eta, double ptCorr, int flavour)
{
...
float SingleTopSystematicsTreesDumper_SChannelEle::muonHLTEff(float eta, string period)
{
    float eff = 0.87;
...
double SingleTopSystematicsTreesDumper_SChannelEle::topPtReweighting(string chanrew, double pt){
  if((channel == "TTBar") || 
  ...
  if(chanrew == "dilepton"){a=0.148;b=-0.00125;}
  return exp(a+b*pt);
  }
  return 1.0;
}
...
void SingleTopSystematicsTreesDumper_SChannelEle::endJob()
{
...
double SingleTopSystematicsTreesDumper_SChannelEle::BTagSFNew(double pt, string algo)
{
...
double SingleTopSystematicsTreesDumper_SChannelEle::BTagSFErrNew(double pt, string algo)
{
    if (algo == "TCHPT")
    {
...
double SingleTopSystematicsTreesDumper_SChannelEle::MisTagSFNew(double pt, double eta, string algo)
{
...
double SingleTopSystematicsTreesDumper_SChannelEle::MisTagSFErrNewUp(double pt, double eta, string algo)
{
    double x = pt;
...
double SingleTopSystematicsTreesDumper_SChannelEle::MisTagSFErrNewDown(double pt, double eta, string algo)
{
    double x = pt;
...
double SingleTopSystematicsTreesDumper_SChannelEle::EFFMapNew(double btag, string algo)
{
...
double SingleTopSystematicsTreesDumper_SChannelEle::BScaleFactor(string algo, string syst_name)
{
...
//WILL BE CHANGED VERY SOON ACCORDING TO NEW PRESCRIPTIONS
double SingleTopSystematicsTreesDumper_SChannelEle::MisTagScaleFactor(string algo, string syst_name, double sf, double eff, double sferr)
{
...
//WILL BE CHANGED VERY SOON ACCORDING TO NEW PRESCRIPTIONS
double SingleTopSystematicsTreesDumper_SChannelEle::AntiBScaleFactor(string algo, string syst_name)
{
...
//void SingleTopSystematicsTreesDumper_SChannelEle::InitializeEventScaleFactorMap()
//{
//
...
//    TCHEL_LAntiMisTagDown = EventAntiScaleFctor("TCHEL_L", "MisTagDown");
//}
//
double SingleTopSystematicsTreesDumper_SChannelEle::SFMap(string algo )
{
...
double SingleTopSystematicsTreesDumper_SChannelEle::SFErrMap(string algo )
{
...
double SingleTopSystematicsTreesDumper_SChannelEle::EFFMap(string algo )
{
...
double SingleTopSystematicsTreesDumper_SChannelEle::EFFMap(string algo, string channel )
{
...
double SingleTopSystematicsTreesDumper_SChannelEle::EFFErrMap(string algo )
{
...
double SingleTopSystematicsTreesDumper_SChannelEle::EventScaleFactor(string algo, string syst_name) //,double sf, double eff, double sferr){
{
...
double SingleTopSystematicsTreesDumper_SChannelEle::EventAntiScaleFactor(string algo, string syst_name )
{
...
//WILL BE CHANGED VERY SOON ACCORDING TO NEW PRESCRIPTIONS
double SingleTopSystematicsTreesDumper_SChannelEle::AntiMisTagScaleFactor(string algo, string syst_name, double sf, double eff, double sferr)
{
    double mistagcentral = sf;
    double mistagerr = sferr;
    double tcheeff = eff;
...
double SingleTopSystematicsTreesDumper_SChannelEle::turnOnWeight (std::vector<double> probabilities, int njets_req = 1)
{
    double prob = 0;
...
int SingleTopSystematicsTreesDumper_SChannelEle::eventFlavour(string ch, int nb, int nc, int nl)
{
...
bool SingleTopSystematicsTreesDumper_SChannelEle::flavourFilter(string ch, int nb, int nc, int nl)
{
...
/*double SingleTopSystematicsTreesDumper_SChannelEle::jetprob(double pt, double btag){
...
double SingleTopSystematicsTreesDumper_SChannelEle::jetprobpt(double pt)
{
    double prob = 0.982 * exp(-30.6 * exp(-0.151 * pt)); //PT turnOn
    return prob;
}

double SingleTopSystematicsTreesDumper_SChannelEle::jetprobbtag(double btag)
{
    double prob = 0.844 * exp((-6.72 * exp(-0.720 * btag))); //BTag turnOn
    return prob;
}

double SingleTopSystematicsTreesDumper_SChannelEle::turnOnProbs(string syst, int n)
{
    if (syst == "JetTrig1Up")
    {
...
void SingleTopSystematicsTreesDumper_SChannelEle::pushJetProbs(double pt, double btag, double eta)
{
...
void SingleTopSystematicsTreesDumper_SChannelEle::InitializeTurnOnReWeight(string rootFile = "CentralJet30BTagIP_2ndSF_mu.root")
{
...
double SingleTopSystematicsTreesDumper_SChannelEle::turnOnReWeight (double preWeight, double pt, double tchpt)
{
...
double SingleTopSystematicsTreesDumper_SChannelEle::jetprob(double pt, double btag, double eta, string syst)
{
    double prob = 1.;
...
double SingleTopSystematicsTreesDumper_SChannelEle::jetprobold(double pt, double btag, double eta, string syst)
{
    double prob = 1.;
...
double SingleTopSystematicsTreesDumper_SChannelEle::bTagSF(int B)
{
...
/*double SingleTopSystematicsTreesDumper_SChannelEle::vetoSF(int B, string syst){
...
double SingleTopSystematicsTreesDumper_SChannelEle::bTagSF(int B, string syst)
{
    //  cout<< " B " << " ntchhpt "<<   ntchpt_tags << " jsfshpt size "<<
    // jsfshpt.size() << " ntchel " << ntchel_tags<< " jsfshel size " << jsfshel.size()<<endl;
    if (algo_ == "TCHPT")
...
double SingleTopSystematicsTreesDumper_SChannelEle::pileUpSF(string syst)
{
...
double SingleTopSystematicsTreesDumper_SChannelEle::resolSF(double eta, string syst)
{
    double fac = 0.;
    if (syst == "JERUp")fac = 1.;
...
//BTag weighter
bool SingleTopSystematicsTreesDumper_SChannelEle::BTagWeight::filter(int t)
{
    return (t >= minTags && t <= maxTags);
}

float SingleTopSystematicsTreesDumper_SChannelEle::BTagWeight::weight(vector<JetInfo> jets, int tags)
{
    if (!filter(tags))
    {
...
float SingleTopSystematicsTreesDumper_SChannelEle::BTagWeight::weightWithVeto(vector<JetInfo> jetsTags, int tags, vector<JetInfo> jetsVetoes, int vetoes)
...
void SingleTopSystematicsTreesDumper_SChannelEle::resetWeightsDoubles()
{
  double baseWeight=0.0,baseWeightMCTruth=0.0;
  //  TH1D * MCHisto = new TH1D("tmp","tmp",3000,0.01,1.5);
  //TH1D * MCHistoMCTruth = new TH1D("tmpmct","tmpmct",3000,0.01,1.5);
    //  treesMCTruth->Project("tmp","topPtReweight");
    //treesMCTruth->Project("tmpmct","topPtReweightMCTruth");
  
    //  baseWeight=MCHisto->GetMean();
    //baseWeightMCTruth=MCHistoMCTruth->GetMean();
  //  delete MCHisto;
  //delete MCHistoMCTruth;
  
  int nentriestot = treesMCTruth->GetEntries();
  ...
  for (int bj = 0; bj <= 5; ++bj)  {
	...
	cout <<  " test 3J " << bj<<" T, syst"<< syst  << "evt # "<<i <<" ptrew "<< topPtReweightNorm<<endl;
...
void SingleTopSystematicsTreesDumper_SChannelEle::muonHLTSF(float etaMu, float ptMu){
...
void SingleTopSystematicsTreesDumper_SChannelEle::electronHLTSF(float etaEle, float ptEle){
...
DEFINE_FWK_MODULE(SingleTopSystematicsTreesDumper_SChannelEle);
