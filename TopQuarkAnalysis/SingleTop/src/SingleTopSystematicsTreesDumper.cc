...
SingleTopSystematicsTreesDumper::SingleTopSystematicsTreesDumper(const edm::ParameterSet &iConfig)
{
    ...
    doMetPhiCorrections_ = iConfig.getUntrackedParameter< bool >("doMetPhiCorrections", false);
    ...
    CentralPDF_ =  iConfig.getUntrackedParameter< std::string >("CentralPDF","CT");
    ...
    if(systematics.size()==1){
      if (systematics.at(0)=="")systematics.at(0)="noSyst";
    }

    bool hasNoSysts=false;
    for(size_t sy = 0; sy<systematics.size();++sy){
      if (systematics.at(sy)=="noSyst") {
	hasNoSysts=true;
	break;
      }
    }
    if(!hasNoSysts) systematics.insert(systematics.begin(), "noSyst");
    ...
    for (size_t i = 0; i < all_syst.size(); ++i)
    {
	    ...
	    // treesNJets[syst]->Branch("lepNH", &leptonNHits);
            ...
            treesNJets[syst]->Branch("metPx", &metPxVar);
            treesNJets[syst]->Branch("metPy", &metPyVar);
            treesNJets[syst]->Branch("metPhi", &metPhi);
            treesNJets[syst]->Branch("metPtNoCor", &metPtNoCor);
            treesNJets[syst]->Branch("metPxNoCor", &metPxVarNoCor);
            treesNJets[syst]->Branch("metPyNoCor", &metPyVarNoCor);
            treesNJets[syst]->Branch("metPhiNoCor", &metPhiVarNoCor);
	    ...
	    cout << " addPDFToNJets is "<< addPDFToNJets<<endl;
	    if(addPDFToNJets){
	      for (int p = 1; p <= 52; ++p)
		{
	      ...
	      treesNJets[syst]->Branch("PDFWeight_Central", &pdf_weights_mstw);
        ...
        for (int bj = 0; bj <= 5; ++bj)
        {
            ...
            else
	      {
           ...
           //2J1T
            ...
            trees2J[bj][syst]->Branch("costhetaSecondBlj", &cosB2Tree);
            trees2J[bj][syst]->Branch("costhetaSecondBbj", &cosB2BTree);
            trees2J[bj][syst]->Branch("costhetaSecondBlbl", &cosB2BLTree);

            trees2J[bj][syst]->Branch("costhetalj", &cosTree);
            trees2J[bj][syst]->Branch("costhetabj", &cosBTree);
	    ...
	    //
            ...
            trees2J[bj][syst]->Branch("secondBJetPt", &secondBJetPt);
            trees2J[bj][syst]->Branch("secondBJetE", &secondBJetE);
            trees2J[bj][syst]->Branch("secondBJetEta", &secondBJetEta);
            trees2J[bj][syst]->Branch("secondBJetPhi", &secondBJetPhi);
            trees2J[bj][syst]->Branch("secondBJetBtag", &secondBJetBTag);
            trees2J[bj][syst]->Branch("secondBJetFlavour", &secondBJetFlavourTree);
            ...
            trees2J[bj][syst]->Branch("metPx", &metPxVar);
            trees2J[bj][syst]->Branch("metPy", &metPyVar);
            trees2J[bj][syst]->Branch("metPtNoCor", &metPtNoCor);
            trees2J[bj][syst]->Branch("metPxNoCor", &metPxVarNoCor);
            trees2J[bj][syst]->Branch("metPyNoCor", &metPyVarNoCor);
            trees2J[bj][syst]->Branch("metPhiNoCor", &metPhiVarNoCor);
	    ...
	    trees2J[bj][syst]->Branch("topSecondBMass", &topB2MassTree);
	    trees2J[bj][syst]->Branch("topSecondBMtw", &topB2MtwTree);
	    
            trees2J[bj][syst]->Branch("topSecondBPt", &topB2Pt);
            trees2J[bj][syst]->Branch("topSecondBPhi", &topB2Phi);
            trees2J[bj][syst]->Branch("topSecondBEta", &topB2Eta);
            trees2J[bj][syst]->Branch("topSecondBE", &topB2E);
	    ...
	    for (int p = 1; p <= 52; ++p)
            ...
            trees2J[bj][syst]->Branch("PDFWeight_Central", &pdf_weights_mstw);
	    ...
	    trees3J[bj][syst] = new TTree(treename.c_str(), treename.c_str());
            ...
            trees3J[bj][syst]->Branch("costhetabj", &cosBTree);
            trees3J[bj][syst]->Branch("costhetalbl", &cosBLTree);

            trees3J[bj][syst]->Branch("costhetaSecondBlj", &cosB2Tree);
            trees3J[bj][syst]->Branch("costhetaSecondBbj", &cosB2BTree);
            trees3J[bj][syst]->Branch("costhetaSecondBlbl", &cosB2BLTree);
	    ...
	    trees3J[bj][syst]->Branch("leptonSFD", &lepSFD);
            ...
            trees3J[bj][syst]->Branch("secondBJetPt", &secondBJetPt);
            trees3J[bj][syst]->Branch("secondBJetE", &secondBJetE);
            trees3J[bj][syst]->Branch("secondBJetEta", &secondBJetEta);
            trees3J[bj][syst]->Branch("secondBJetPhi", &secondBJetPhi);
            trees3J[bj][syst]->Branch("secondBJetBtag", &secondBJetBTag);
            trees3J[bj][syst]->Branch("secondBJetFlavour", &secondBJetFlavourTree);
            ...
            trees3J[bj][syst]->Branch("topSecondBMass", &topB2MassTree);
            trees3J[bj][syst]->Branch("topSecondBMtw", &topB2MtwTree);

            trees3J[bj][syst]->Branch("topSecondBPt", &topB2Pt);
            trees3J[bj][syst]->Branch("topSecondBPhi", &topB2Phi);
            trees3J[bj][syst]->Branch("topSecondBEta", &topB2Eta);
            trees3J[bj][syst]->Branch("topSecondBE", &topB2E);
	    ...
	    //            trees3J[bj][syst]->Branch("lepNH", &leptonNHits);
            ...
            trees3J[bj][syst]->Branch("PDFWeight_Central", &pdf_weights_mstw);
    ...
    if(CentralPDF_ == "CT") { 
      LHAPDF::initPDFSet(1, "cteq66.LHgrid");
      LHAPDF::initPDFSet(2, "cteq66.LHgrid");
    }
    if(CentralPDF_ == "CT10") { 
      LHAPDF::initPDFSet(1, "CT10.LHgrid");
      LHAPDF::initPDFSet(2, "CT10.LHgrid");
    }
    if(CentralPDF_ == "CT10f4") { 
      LHAPDF::initPDFSet(1, "CT10f4.LHgrid");
      LHAPDF::initPDFSet(2, "CT10f4.LHgrid");
    }
    if(CentralPDF_ == "MSTW") { 
      LHAPDF::initPDFSet(1, "MSTW2008nlo68cl.LHgrid");
      LHAPDF::initPDFSet(2, "CT10.LHgrid");
    }
    if(CentralPDF_ == "NNPDF") { 
      LHAPDF::initPDFSet(1, "NNPDF21_100.LHgrid");
      LHAPDF::initPDFSet(2, "CT10.LHgrid");
    }
...
void SingleTopSystematicsTreesDumper::analyze(const Event &iEvent, const EventSetup &iSetup)
{
    ...
    int secondBTagTreePositionNoSyst = -1;
	...
	if (!didLeptonLoop)
		...
		cout << "qcd lep size" <<qcdLeptonsDeltaCorrectedRelIso->size()<<endl;
		  ...
		  if (leptonsFlavour_ == "muon")
		    ...
		    //		    bool passesLooseLeptons = (looseMuonsDeltaCorrectedRelIso->size() + looseElectronsDeltaCorrectedRelIso->size()) == 1;
		    //		    FIXMEUP BEFORE YOU GOGO!!
		    //		    if (!passesLooseLeptons) continue;
        ...
        if (!gotMets)
        {
            ...
            metPhi = METPhi->at(0);
            metPtNoCor = METPt->at(0);
	    
	    metPhiVarNoCor = metPhi;
	    metPxVarNoCor = metPx;
	    metPyVarNoCor = metPy;

	    if(doMetPhiCorrections_){
	      if(channel =="Data"){
		metPx -= ((3.54233e-01 + 2.65299e-01*npv));
		metPy -= ((1.88923e-01 - 1.66425e-01*npv));
	      }
	      else {
		metPx -= ((-2.99576e-02 - 6.61932e-02*npv));
		metPy -= ((3.70819e-01 - 1.48617e-01*npv));
	      }
	    }
	    ...
	    if(metPx<0){
	      if(metPy>0)metPhi = atan(metPy/metPx)+3.141592;
	      if(metPy<0)metPhi = atan(metPy/metPx)-3.141592;
	    }
	    else  metPhi = (atan(metPy/metPx));
		...
		cout <<" njets "<< nJets <<endl;
		  ...
		  if (is_btag_relevant )
		      ...
		      //		      double hpteff = EFFMap("TCHPT_C",ptCorr);
			  ...
			  jsfscsvm_b_tag_down.push_back(BTagWeight::JetInfo(csvmeff, csvmSF - 2 * csvmSFErr));
                ...
                else if (abs(flavour) == 5)
                {
                    ...
                    if (is_btag_relevant )
                    {
                        ...
                        double csvteff = EFFMap("CSVT_B");
                        double csvmeff = EFFMap("CSVL_B");

			//                        double hpteff = EFFMap("TCHPT_B",ptCorr);
			...
			//                        double hpteff = EFFMap("TCHPT_L",ptCorr);
	...
	if ( syst_name == "JESUp" || syst_name == "JESDown" || syst_name == "JERDown" || syst_name == "JERUp" || syst_name == "noSyst"){
	  ...
	  for (size_t i = 0; i < allJetsPt->size(); ++i) {
        ...
        {
            double bt = btags[J_];
            if (bt < highBTagTree &&  bt > secondBJetBTag)
	      {
                secondBJetBTag = bt;
                secondBTagTreePosition = J_ ;
                secondBJetFlavourTree = flavours[J_];
            }
        }
	...
	if(doJetTrees_)isQCDTree= isQCD;
		...
		if(addPDFToNJets){
		  ...
		  double xpdf1 = LHAPDF::xfx(2, x1, scalePDF, id1);
		  double xpdf2 = LHAPDF::xfx(2, x2, scalePDF, id2);
		  double w0 = xpdf1 * xpdf2;
		  pdf_weights_mstw= w0;
		  //Uncs
		  int maxPDFCount = 52;
		  if(CentralPDF_=="CT")maxPDFCount=44;
		  if(CentralPDF_=="CT10")maxPDFCount=52;
		  if(CentralPDF_=="MSTW")maxPDFCount=40;
		  if(CentralPDF_=="NNPDF")maxPDFCount=50;
		  for (int p = 1; p <= 52; ++p)
                    {
	...
	//    2T_QCD=5;
		...
		++passingBJets;
            ...
            math::PtEtaPhiELorentzVector topB2 = top4Momentum(leptonPFour, jets[secondBTagTreePosition], metPx, metPy);
            float fCosThetaB2LJ =  cosThetaLJ(leptonPFour, jets[lowBTagTreePosition], topB2);
            cosB2BLTree =  cosTheta_eta_bl(leptonPFour, jets[lowBTagTreePosition], topB2);
	    
            etaTree = fabs(jets[lowBTagTreePosition].eta());
            cosTree = fCosThetaLJ;
            cosB2Tree = fCosThetaLJ;

            topMassTree = top.mass();
            topB2MassTree = topB2.mass();

            topMtwTree = topMtw(leptonPFour, jets[highBTagTreePosition], metPx, metPy);
            topB2MtwTree = topMtw(leptonPFour, jets[highBTagTreePosition], metPx, metPy);
	    ...
	    if (leptonsFlavour_ == "electron" )lepEff = 1;
            ...
            secondBJetPt = jets[secondBTagTreePosition].pt();
            secondBJetE = jets[secondBTagTreePosition].energy();
            secondBJetEta = jets[secondBTagTreePosition].eta();
            secondBJetPhi = jets[secondBTagTreePosition].phi();
...
{
    if (algo == "TCHPT_B")return 0.365 * 2.;
...
double SingleTopSystematicsTreesDumper::EFFMapPt(string algo, double pt )
{

  double PTS = 1.;
  if(pt < 50)PTS = 45;
  if(pt > 50 && pt <60  )PTS = 45;
  if(pt > 60 && pt <70  )PTS = 47;
  if(pt > 70 && pt <80  )PTS = 50;
  if(pt > 80 && pt <100  )PTS = 50;
  if(pt >120 && pt <160  )PTS = 55;
  if(pt >160 && pt <210  )PTS = 56;
  if(pt >210 && pt <260  )PTS = 56;
  if(pt >210 && pt <260  )PTS = 47;
  if(pt >260 && pt <320  )PTS = 47;
  if(pt >320  )PTS = 42;
  PTS = PTS/45.0;

    if (algo == "TCHPT_B")return 0.365 * PTS;
    if (algo == "TCHPT_C")return 0.0365*PTS;
    if (algo == "TCHPT_L")return 0.0017*PTS;
