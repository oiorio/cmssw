...
#jetLooseCut = cms.string("pt<40")



#Requirement on the number of leptons in the event
#Tight: at least 1 tight lepton
...
#QCD:  at least 1 tight lepton
minQCDLeptons = cms.untracked.int32(1)
maxQCDLeptons = cms.untracked.int32(99)
...
countLeptons.minNumberQCD = minQCDLeptons
countLeptons.maxNumberQCD = maxQCDLeptons
