...
ChannelName = "TChannel_SingleTopSkim_TChannel_Data_False_isGsf_False_hasPFTaus_False_isHermetic_False_hasRunMETUnc_False"
...
process.pfCandMETcorr.src = cms.InputTag("pfCandsNotInJet")
