...
#Extension
    if channel == "TTBarFullLepExt1":
        return "/TTJets_FullLeptMGDecays_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V7A-v2/AODSIM"

    if channel == "TTBarSemiLepExt0":
        return "/TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola/Summer12_DR53X-PU_S10_START53_V7C-v1/AODSIM"
    if channel == "TTBarSemiLepExt1":
        return "/TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola/Summer12_DR53X-PU_S10_START53_V19_ext2-v1/AODSIM"
    if channel == "TTBarSemiLepExt2":
        return "/TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola/Summer12_DR53X-PU_S10_START53_V19_ext2-v2/AODSIM"
    

    if channel == "WJets":
        return "/WJetsToLNu_TuneZ2Star_8TeV-madgraph-tarball/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM"
    if channel == "WJetsSherpa":
        return "/WJets_0p1_1p2_2p10_3p20_4p20_5p20_CT10_8TeV-sherpa/Summer12_DR53X-PU_S10_START53_V7C-v1/AODSIM"
    if channel == "WJetsBig":
...
#Still TO BE UPDATED
    ...
    if channel == "QCD_HT_40_100_GJets":
        return "/GJets_HT-40To100_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V19-v1/AODSIM"
    if channel == "QCD_HT_100_200_GJets":
        return "/GJets_HT-100To200_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V19-v1/AODSIM"
    if channel == "QCD_HT_200_400_GJets":
        return "/GJets_HT-200To400_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM"
    if channel == "QCD_HT_400_inf_GJets":
        return "/GJets_HT-400ToInf_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM"
    
    if channel == "W1Jet":
        return "/W1JetsToLNu_TuneZ2Star_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM"
    if channel == "W2Jets":
        return "/W2JetsToLNu_TuneZ2Star_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM"
    if channel == "W3Jets":
        return "/W3JetsToLNu_TuneZ2Star_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM"
    if channel == "W4Jets":
        return "/W4JetsToLNu_TuneZ2Star_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM"
...
def entriesmap(channel):
    ...
    if channel == "TTBar" or channel == "TWChannel" or channel == "TbarWChannel" or channel == "SChannel" or channel == "SbarChannel" or channel == "WW" or channel == "WZ" or channel == "ZZ" or "QCD_HT" in channel or channel == "TbarChannel_Q2Up" or channel == "TbarChannel_Q2Down" or channel == "TChannel_Q2Up":
        return 50000
    ...
    if "QCD_Pt" in channel and "EMEnriched" in channel:
        return 100000
    ...
    if "TTBarFullLep" in channel or "TTBarSemiLep" in channel:
        return 150000
    ...
    if channel == "WJets" or channel == "ZJets" or channel == "QCDMu" or "Pt_20to30" in channel:
        return 75000
    if "Pt_30to80" in channel:
        return 30000
    if channel == "WJetsSherpa":
        return 205000
    if channel == "WJetsBig":
