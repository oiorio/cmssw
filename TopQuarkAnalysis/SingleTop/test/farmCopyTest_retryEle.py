...
path = "/cms/store/user/oiorio/SingleTop/Fall12/ReRecoJun22/"
#path = "/cms/store/user/oiorio/SingleTop/Fall12/"
...
#"Ele_B1_22Jan","Ele_B2_22Jan","Ele_B3_22Jan",
"Ele_B4_22Jan",
...
for attempt in range(1,nRetries):
    ...
    for channel in channels:
        #command_ls_channel = command_ls[:-1] + channel +'" | grep _D | grep Ele'
