...
runMEtUncertainties(process, electronCollection = cms.InputTag('selectedPatElectrons'), photonCollection = None, muonCollection = cms.InputTag('selectedPatMuons'), tauCollection = cms.InputTag('selectedPatTaus'), jetCollection = cms.InputTag('selectedPatJets') , dRjetCleaning = 0.5, doApplyType0corr = True, doSmearJets = True, pfCandCollection= cms.InputTag('particleFlow'),varyByNsigmas=1.0,outputModule = 'singleTopPatTuple')
