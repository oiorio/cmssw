...
doMetPhiCorrections = cms.untracked.bool(False),
#doMetPhiCorrections = cms.untracked.bool(True),
...
CentralPDF = cms.untracked.string("CT"),#"CT","CT10","NNPDF","MSTW"
#CentralPDF = cms.untracked.string("MSTW"),#"CT","CT10","NNPDF","MSTW"
#CentralPDF = cms.untracked.string("NNPDF"),#"CT","CT10","NNPDF","MSTW"
useMVAID  = cms.untracked.bool(True),
useCutBasedID  = cms.untracked.bool(False),
#useMVAID  = cms.untracked.bool(False),
#useCutBasedID  = cms.untracked.bool(True),
...
channelInfo = cms.PSet(
    ...
    mcPUFile = cms.untracked.string("pileupdistr_TChannel.root"),
    puHistoName = cms.untracked.string("pileUpDumper/PileUpTChannel"),
    addPDFToNJets = cms.untracked.bool(True),
...
#looseElectronsDeltaCorrectedRelIso = cms.InputTag("nTupleVetoElectronsMVA","vetoElectronsMVAPFDeltaCorrectedRelIso"),  
#looseElectronsRhoCorrectedRelIso = cms.InputTag("nTupleVetoElectronsMVA","vetoElectronsMVAPFRhoCorrectedRelIso"),  
#
