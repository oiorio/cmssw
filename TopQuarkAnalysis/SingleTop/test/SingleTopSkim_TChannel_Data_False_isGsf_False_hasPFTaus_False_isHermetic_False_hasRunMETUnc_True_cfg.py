...
ChannelName = "TChannel_SingleTopSkim_TChannel_Data_False_isGsf_False_hasPFTaus_False_isHermetic_False_hasRunMETUnc_True"
...
if doRunMETUncertainties:
    ...
    process.patPFMet.metSource = cms.InputTag("pfMET")
    process.patJetsNotOverlappingWithLeptonsForMEtUncertainty.checkOverlaps.muons.requireNoOverlap = cms.untracked.bool(False)
    process.patJetsNotOverlappingWithLeptonsForMEtUncertainty.checkOverlaps.electrons.requireNoOverlap = cms.untracked.bool(False)
...
process.singleTopPatTuple = cms.OutputModule(
    "PoolOutputModule",
    fileName = cms.untracked.string('/tmp/oiorio/singleTopSkim_'+ChannelName+'.root'),
...
process.singleTopNTupleOut = cms.OutputModule(
    "PoolOutputModule",
    fileName = cms.untracked.string('/tmp/oiorio/singleTopEdmNtuple_'+ChannelName+'.root'),
