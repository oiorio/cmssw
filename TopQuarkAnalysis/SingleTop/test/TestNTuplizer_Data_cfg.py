...
#process.TFileService = cms.Service("TFileService", fileName = cms.string("DataEle_test_mva_cut.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("DataEle_test_fullmva.root"))
...
channel_instruction = "ele" #SWITCH_INSTRUCTION
